...
const testimonials = [
  ...
  },
  {
    ...
    metric: "+340% em leads em 30 dias",
    initial: "R",
  },
  {
    quote:
      "Eu já tinha testado 3 agências. A Ad Expand foi a primeira que entendeu que LP boa é a que vende, não a que ganha prêmio. CPL caiu 40% na primeira semana.",
    name: "Juliana P.",
    role: "E-commerce de cosméticos",
    metric: "−40% de CPL em 7 dias",
    initial: "J",
  },
];
              ...
              <div className="relative bg-[color:var(--ink-900)] border border-[color:var(--ink-800)] rounded-3xl p-7 md:p-8 h-full flex flex-col">
                ...
                <div className="pt-6 border-t border-[color:var(--ink-800)]">
                  <div className="flex items-center gap-3 mb-4">
                    <div className="w-11 h-11 rounded-full bg-gradient-to-br from-[color:var(--gold-500)] to-[color:var(--gold-600)] text-[color:var(--ink-950)] flex items-center justify-center font-display font-bold text-lg shrink-0">
                      {t.initial}
                    </div>
                    <div>
