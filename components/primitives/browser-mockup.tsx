...
export function BrowserMockup() {
  return (
    <motion.div
      ...
      aria-hidden="true"
    >
      <div className="rounded-3xl overflow-hidden border border-[color:var(--ink-800)] bg-[color:var(--ink-900)] shadow-2xl glow-gold">
        {/* Browser chrome */}
        ...
        {/* Fake LP */}
        <div className="p-6 md:p-8 space-y-5 bg-gradient-to-b from-[color:var(--ink-900)] to-[color:var(--ink-950)]">
      ...
      <motion.div
        ...
        className="absolute -left-4 md:-left-8 top-8 bg-[color:var(--ink-900)] border border-[color:var(--ink-800)] rounded-xl px-3 py-2 text-[11px] font-mono shadow-lg"
      >
        <div className="text-[color:var(--gold-500)] font-semibold">+340%</div>
        <div className="text-[color:var(--text-on-dark-muted)] text-[9px]">leads / 30d</div>
      </motion.div>
      ...
      <motion.div
        ...
        className="absolute -right-2 md:-right-6 bottom-10 bg-[color:var(--ink-900)] border border-[color:var(--ink-800)] rounded-xl px-3 py-2 text-[11px] font-mono shadow-lg"
      >
        <div className="text-[color:var(--gold-500)] font-semibold">R$ 2,18</div>
        <div className="text-[color:var(--text-on-dark-muted)] text-[9px]">CPL médio</div>
      </motion.div>
    </motion.div>
  );
}
